...
PARAM$input$testing <- c(202108) # nolint
PARAM$input$validation <- c(202107)
PARAM$input$training <- c( 201901, 201902, 201903, 201904, 201905, 202906, # nolint
  201907, 201908,201908, 201909, 201910, 201911, 201912, 202001, 202002, # nolint
...
PARAM$bo_lgb <- makeParamSet(
  makeNumericParam("learning_rate", lower = 0.02, upper = 0.16),
