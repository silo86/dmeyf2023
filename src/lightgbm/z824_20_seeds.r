...
PARAM <- list()
PARAM$experimento <- "final20seeds"
...
PARAM$finalmodel$optim$num_iterations <- 498
PARAM$finalmodel$optim$learning_rate <- 0.70
PARAM$finalmodel$optim$feature_fraction <- 0.10
PARAM$finalmodel$optim$min_data_in_leaf <- 49947
...
tb_entrega[, prob := predicciones_promedio]
